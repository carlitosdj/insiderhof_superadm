        ...
        <div className="d-flex flex-column flex-xl-row flex-row-fluid">
          <div className="flex-row-fluid py-lg-2 px-lg-6">
            ...
            <Form.Group controlId="formDescription">
              <Form.Label className="required fw-bold fs-6 mb-5">Gateway</Form.Label>
              <Form.Control
                placeholder=""
                required
                value={gateway}
            ...
            <Form.Group controlId="fromSlug">
              <Form.Label className="required fw-bold fs-6 mb-5">PaymentMethod</Form.Label>
              <Form.Control
                placeholder=""
                required
                value={paymentmethod}
            ...
            <Form.Group controlId="fromMaxclicks">
              <Form.Label className="required fw-bold fs-6 mb-5">Installments</Form.Label>
              <Form.Control
                placeholder=""
                required
                value={installments}
            ...
            <br />
            <Form.Group controlId="fromMaxclicks">
              <Form.Label className="required fw-bold fs-6 mb-5">Price</Form.Label>
              <Form.Control
                placeholder=""
                required
                value={price}
            ...
            <br />
            <Form.Group controlId="fromMaxclicks">
              <Form.Label className="required fw-bold fs-6 mb-5">Quantity</Form.Label>
              <Form.Control
                placeholder=""
                required
                value={quantity}
            ...
            <br />
            <Form.Group controlId="fromMaxclicks">
              <Form.Label className="required fw-bold fs-6 mb-5">Description</Form.Label>
              <Form.Control
                placeholder=""
                required
                value={description}
            ...
            <br />
            <Form.Group controlId="fromMaxclicks">
              <Form.Label className="required fw-bold fs-6 mb-5">Idreference</Form.Label>
              <Form.Control
                placeholder=""
                required
                value={idreference}
            ...
            <br />
            <Form.Group controlId="fromMaxclicks">
              <Form.Label className="required fw-bold fs-6 mb-5">Notafiscal</Form.Label>
              <Form.Control
                placeholder=""
                required
                value={notafiscal}
            ...
            <br />
            <Form.Group controlId="fromMaxclicks">
              <Form.Label className="required fw-bold fs-6 mb-5">launchId</Form.Label>
              <Form.Control
                placeholder=""
                required
                value={launchId}
            ...
            <br />
            <Form.Group controlId="fromMaxclicks">
              <Form.Label className="required fw-bold fs-6 mb-5">Total paid amount</Form.Label>
              <Form.Control
                placeholder=""
                required
            ...
            <br />
            <Form.Group controlId="fromMaxclicks">
              <Form.Label className="required fw-bold fs-6 mb-5">Net received amount</Form.Label>
              <Form.Control
                placeholder=""
                required
            ...
            <br />
            <Form.Group controlId="fromMaxclicks">
              <Form.Label className="required fw-bold fs-6 mb-5">Instalment amount</Form.Label>
              <Form.Control
                placeholder=""
                required
            ...
            <br />
            <Form.Group controlId="fromMaxclicks">
              <Form.Label className="required fw-bold fs-6 mb-5">Mercado pago fee</Form.Label>
              <Form.Control
                placeholder=""
                required
            ...
            <br />
            <Form.Group controlId="fromMaxclicks">
              <Form.Label className="required fw-bold fs-6 mb-5">Financing fee</Form.Label>
              <Form.Control
                placeholder=""
                required
                value={financing_fee}
